<?php
namespace nubors\filemanager\widgets;

use Yii;
use yii\helpers\Html;
use yii\widgets\InputWidget;
use nubors\filemanager\assets\FileInputAsset;
use yii\helpers\Url;
 ...
 * More samples of usage see on github: https://github.com/nubors/yii2-filemanager
 *
 * @package nubors\filemanager\widgets
...
class FileInput extends InputWidget
{
    ...
    public function run()
    {
        ...
        $modal = $this->renderFile('@vendor/nubors/yii2-filemanager/views/file/modal.php', [
